              ...
              <div class="wrapper row3">
                <div class="rounded">
                  <main class="container clear"> 
                    ...
                    <!-- ################################################################################################ -->
                    <div id="portfolio">
                      <div class="head"><?php echo $activite->activite_title;?>       
                    </div>
                    <div class="line" ></div>
                  </div>
                  <div class="groupp">
                    <div class="onehalf first" >
                      <?php echo $activite->activite_description;?>
                    </div>
                    <div class="onehalf"><img src="<?php echo base_url();?>assets/images/<?php echo $activite->activite_images;?>" ></div>
                  </div>
