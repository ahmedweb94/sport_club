  ...
  <div class="col-md-12 form f-label">
    ...
    <div class="box box-success pad-profile">
      <div class="box-header with-border">
        <h3 class="box-title">الحساب الشخصى <small></small></h3>
      </div>
          ...
          <div class="col-md-3">
            ...
            <div class="col-md-8">
              ...
              <div class="form-group has-feedback">
                <label for="exampleInputstatus">حالة العضوية:</label>
                <select name="status" id="status" class="form-control">
                 <option value="active" <?php echo (isset($user_data[0]->status) && $user_data[0]->status == 'active' ?'selected="selected"':'');?> >تنشيط</option>
                 
                 <option value="deleted" <?php echo (isset($user_data[0]->status) && $user_data[0]->status == 'deleted' ?'selected="selected"':'');?> >حذف</option>
             ...
             <div class="form-group has-feedback clear-both">
              <label for="exampleInputname">اسم العضو:</label>
            ...
            <div class="form-group has-feedback">
              <label for="exampleInputEmail1">اعد كلمة المرور:</label>
