<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo base_url(); ?>"><b>ادارة الاعضاء</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
      <p class="login-box-msg">ادخل بريدك الالكترونى وسيصلك رابط تعديل كلمة المرور على بريدك.</p>
      ...
      <form action="<?php echo base_url().'user/forgetpassword'?>" method="post">
        ...
        <div class="row">
          <!-- /.col -->
          <div class="col-xs-12">
            <button type="submit" class="btn btn-primary btn-block btn-flat btn-color">اعادة كلمة المرور</button>
          </div>
