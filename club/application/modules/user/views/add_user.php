<form role="form bor-rad" enctype="multipart/form-data" action="<?php echo base_url().'user/add_edit'?>" method="post">
  <div class="box-body">
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label for="status"> حالة العضوية</label>
          <select name="status" id="" class="form-control">
           <option value="active" <?php echo (isset($userData->status) && $userData->status == 'active')?'selected':''; ?> >تنشيط</option>
           
           <option value="deleted" <?php echo (isset($userData->status) && $userData->status == 'deleted')?'selected':''; ?> >حذف</option>
    ...
    <?php } if(isset($userData)){ ?>
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label for="">اعد كلمة المرور</label>
    ...
    <div class="col-md-12"> 
      <div class="form-group imsize">
        <label for="exampleInputFile">الصورة الشخصيه</label>
