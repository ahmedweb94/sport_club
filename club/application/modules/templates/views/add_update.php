<form action="<?php echo base_url()."templates/add_edit"; ?>" method="post" role="form" id="form" enctype="multipart/form-data" style="padding: 0px 30px">
	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<label for="template_name">اسم النموذج</label>
		...
		<div class="form-group template-vars">
			<label for="help-variables">متغيرات الارسال</label>
			<div class="help-variables-div">
				...
				<p class="line">
					...
					<span class="col-md-7">
						<strong>: الموقع الالكترونى للراسل</strong>
					</span>
				</p>
				<p class="line">
					<span class="col-md-4">
				...
				<p class="line">
					...
					<span class="col-md-7">
						<strong>: رابط الدعوة للتسجيل</strong>
					</span>
				</p>
			</div>
		</div>
	...
	<div class="box-footer sub-btn-wdt">
		<input type="submit" value="حفظ" name="save" class="btn btn-success wdt-bg">
	</div>
</form>
<script>
