            ...
            <div class="tabbable tabs-left">
              <ul id="myTab4" class="nav nav-tabs col-md-3">
                ...
                <li id="permis">
                  <a href="#permissionSetting" data-toggle="tab">
                    ...
                    <span>تصاريح المشرفين</span>
                  </a>
                </li>
                <li id="templates">
                  <a href="#templates-div" data-toggle="tab">
                    <i class="fa fa-puzzle-piece" aria-hidden="true"></i> 
                    <span>قوالب الرسائل البريدية</span>
                  </a>
                </li>
              </ul>
              <div class="tab-content col-md-9">
                ...
                <div class="tab-pane fade active in" id="tab_General">
                  <div class="row">
                    <div class="box-header my-header">
                      <h3 class="box-title">الاعدادات العامة</h3>
                    </div>
                  </div>
                        ...
                        <div class="box-body">
                          <div class="row">                                    
                            <div class="form-group">
                              <label class="control-label col-sm-2 thfont" for="">اسم الموقع:</label>
                              <div class="col-sm-10">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <label for="register_allowed " class="thfont">
                                    <input name="register_allowed" type="checkbox" id="register_allowed"  <?php if(isset($result['register_allowed'])&& $result['register_allowed']==1){echo'checked="checked"';}?> value="1" > السماح بتسجيل عضويات جديدة.
                                  </label>
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="control-label col-sm-2 thfont" for="">نوع العضو:</label>
                                <div class="col-sm-5">
                          ...
                          <div class="row">     
                            <div class="form-group col-md-2 col-sm-2  col-xs-2 ">
                              <span for="exampleInputFile">شعار الموقع: </span>
                            </div>
                          ...
                          <div class="row">
                            <div class="form-group col-md-2 col-sm-2  col-xs-2 dsize">
                              <span for="exampleInputFile" class="thfont">الشعار المصغر: </span>
                            </div>
                          ...
                          <div class="row col-md-10" align="center">
                            <div class="form-group sub-btn-wdt">
                              <input type="submit" value="حفظ" class="btn btn-success wdt-bg">
                            </div>          
                          </div>
                        </div>                                                
                        <!-- /.box-body -->
                ...
                <div class="tab-pane fade" id="emailSetting">
                  <div class="row">
                    <div class="box-header my-header">
                      <h3 class="box-title">البريد الالكترونى</h3>
                    </div>
                  </div>
                  <form method="post" enctype="multipart/form-data" action="<?php echo base_url().'setting/edit_setting' ?>" data-parsley-validate class="form-horizontal form-label-left demo-form2">
                    <div class="row">
                      <div class="">                
                        <div class="form-group m-t-20">
                          <label class="control-label col-sm-2 box-title thfont" for="">اعدادات البريد</label>
                          <div class="col-sm-10">
                        ...
                        <div id="simplemail"  style="display:<?php if(isset($result['mail_setting']) && $result['mail_setting']=='simple_mail'){echo "block";}else{ echo 'none'; }?>;">
                          ...
                          <div class="form-group">
                            <label class="control-label col-sm-2 thfont" for="EMAIL">البريد الالكترونى:</label>
                            <div class="col-sm-10">
                ...
                <div class="tab-pane " id="permissionSetting">
                  ...
                  <div class="panel-group" id="accordion">
                    <h5 class="over-title">
                      <div class="row form-horizontal">
                        <div class="col-md-3">
                          <a class="btn btn-o btn-success" id="addmoreRoles" href="#"><i class="fa fa-plus"></i> اضافة مجموعة ادارية</a>
                        </div>
                        <div class="col-md-9">
                          <div class="form-horizontal"  id="addmoreRolesShow">
                            <form>
                              <div class="form-group">
                                <label for="roles" class="control-label col-md-2 thfont">اسم المجموعة</label>
                                <div class="col-md-5">
                                  <input type="text" name="roles"  id="roles"  class="form-control" placeholder="Enter User Roles" />
                                  <p id="showRolesMSG" style="color:red;"></p>
                                </div>
                                <button type="button" id="rolesAdd" class="btn  btn-success">اضافة</button>
                              </div>
                            </form>
                          </div>
                        </div>
                  ...
                  <form class="form-horizontal" action="<?php echo base_url().'setting/permission' ?>" method="post">
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">
                              <h4 class="panel-title">
                                <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse_<?php echo $id;?>"><i class="fa fa-bars"></i> <?php echo  'تصاريح مجموعة المشرفين: '. ucfirst($user_type);?></a></h4>
                              </div>
                                  ...
                                  <table class="table table-bordered dt-responsive rolesPermissionTable">
                                    ...
                                    <tbody>
                                      ...
                                      if(isset($data) && !empty($data)){
                                        ...
                                        <tr>
                                          <th scope="row" class="thfont">تصاريح الادارة</th>
                                        ...
                                        <tr>
                                          <th scope="row" class="thfont">جميع التصاريح</th>
                                          <td>-</td>
                    ...
                    ?>
                    <hr>
                    <input type="submit" name="save" value="حفظ" class="btn btn-wide btn-success margin-top-20" />
                  <?php } ?>
                </form> 
              </div>
              <!-- /.panel -->
