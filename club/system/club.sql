...
CREATE TABLE `contact` (
  `id` int(11) NOT NULL,
  `google_mab` varchar(100) NOT NULL,
...
--
-- in use(#1932 - Table 'club.main' doesn't exist in engine)
-- Error reading data: (#1932 - Table 'club.main' doesn't exist in engine)

-- --------------------------------------------------------

--
-- Table structure for table `mangement_member`
--

CREATE TABLE `mangement_member` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `phone` int(11) NOT NULL,
  `address` varchar(100) NOT NULL,
...
--
-- Table structure for table `mangement_position`
--

CREATE TABLE `mangement_position` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `team_system_member`
--

CREATE TABLE `team_system_member` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `position_id` int(11) NOT NULL,
  `age` int(11) NOT NULL,
...
--
-- Table structure for table `team_system_position`
--

CREATE TABLE `team_system_position` (
  `id` int(11) NOT NULL,
  `position` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `mangement_member`
--
ALTER TABLE `mangement_member`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mangement_position`
--
ALTER TABLE `mangement_position`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `team_system_member`
--
ALTER TABLE `team_system_member`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `team_system_position`
--
ALTER TABLE `team_system_position`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `jobs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mangement_member`
--
ALTER TABLE `mangement_member`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mangement_position`
--
ALTER TABLE `mangement_position`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `team_system_member`
--
ALTER TABLE `team_system_member`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `team_system_position`
--
ALTER TABLE `team_system_position`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
