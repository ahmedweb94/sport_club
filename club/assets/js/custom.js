$(document).ready(function() {
  ...
  $(".content-wrapper").on("click",".modalButtonsection", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'news_section/get_modal',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_section').find('.modal-body').html(data);
      $('#nameModal_section').modal('show'); 
    })
  });

 
    $(".content-wrapper").on("click",".modalButtonchamp", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'champ/get_modal',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_champ').find('.modal-body').html(data);
      $('#nameModal_champ').modal('show'); 
    })
  });

    $(".content-wrapper").on("click",".modalButtonteam", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'team/get_modal',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_team').find('.modal-body').html(data);
      $('#nameModal_team').modal('show'); 
    })
  });
    
    $(".content-wrapper").on("click",".modalButtongame", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'game/get_modal',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_game').find('.modal-body').html(data);
      $('#nameModal_game').modal('show'); 
    })
  });
    
    $(".content-wrapper").on("click",".modalButtonmatches", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'matches/get_modal',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_matches').find('.modal-body').html(data);
      $('#nameModal_matches').modal('show'); 
    })
  });

  $(".content-wrapper").on("click",".modalButtonrank", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'rank/get_modal',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_rank').find('.modal-body').html(data);
      $('#nameModal_rank').modal('show'); 
    })
  });
 ...
 $(".content-wrapper").on("click",".modalButtonnews", function(e) {
    ...
    $(".content-wrapper").on("click",".modalButtonproject", function(e) {
    $.ajax({
      url : $('body').attr('data-base-url') + 'project/get_modal',
      method: 'post', 
      data : {
        id: $(this).attr('data-src')
      }
    }).done(function(data) {
      $('#nameModal_project').find('.modal-body').html(data);
      $('#nameModal_project').modal('show'); 
    })
  });
    ...
    $(".content-wrapper").on("click",".modalButtonactivite", function(e) {
        $.ajax({
            url : $('body').attr('data-base-url') + 'activite/get_modal',
            method: 'post',
            data : {
                id: $(this).attr('data-src'),
		view: $(this).attr('data-view')
            ...
            $('#nameModal_activite').find('.modal-body').html(data);
            $('#nameModal_activite').modal('show');
        })
    });
    ...
    $(".content-wrapper").on("click",".modalButtonparty", function(e) {
        $.ajax({
            url : $('body').attr('data-base-url') + 'party/get_modal',
            method: 'post',
            data : {
                id: $(this).attr('data-src')
            }
        }).done(function(data) {
            $('#nameModal_party').find('.modal-body').html(data);
            $('#nameModal_party').modal('show');
        })
    });



    $(".content-wrapper").on("click",".modalButtontrip", function(e) {
        $.ajax({
            url : $('body').attr('data-base-url') + 'trip/get_modal',
            method: 'post',
            data : {
                id: $(this).attr('data-src')
            }
        }).done(function(data) {
            $('#nameModal_trip').find('.modal-body').html(data);
            $('#nameModal_trip').modal('show');
        })
    });



    $(".content-wrapper").on("click",".modalButtonachive", function(e) {
        $.ajax({
            url : $('body').attr('data-base-url') + 'achive/get_modal',
            method: 'post',
            data : {
                id: $(this).attr('data-src')
            }
        }).done(function(data) {
            $('#nameModal_achive').find('.modal-body').html(data);
            $('#nameModal_achive').modal('show');
        })
    });

    $(".content-wrapper").on("click",".modalButtonacademy", function(e) {
        $.ajax({
            url : $('body').attr('data-base-url') + 'academy/get_modal',
            method: 'post',
            data : {
                id: $(this).attr('data-src')
            }
        }).done(function(data) {
            $('#nameModal_academy').find('.modal-body').html(data);
            $('#nameModal_academy').modal('show');
        })
    });
 
    $(".content-wrapper").on("click",".modalButtonmain", function(e) {
        $.ajax({
            url : $('body').attr('data-base-url') + 'main/get_modal',
            method: 'post',
            data : {
                id: $(this).attr('data-src')
            }
        }).done(function(data) {
            $('#nameModal_main').find('.modal-body').html(data);
            $('#nameModal_main').modal('show');
        })
    });
    $(".content-wrapper").on("click",".modalButtonsection1", function(e) {
        $.ajax({
            url : $('body').attr('data-base-url') + 'project_section/get_modal',
            method: 'post',
            data : {
                id: $(this).attr('data-src')
            }
        }).done(function(data) {
            $('#nameModal_section1').find('.modal-body').html(data);
            $('#nameModal_section1').modal('show');
        })
    });
